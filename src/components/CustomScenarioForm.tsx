  ...
  useEffect(() => {
    if (editingScenario) {
      setForm({
        ...
        title_zh: editingScenario.title_zh,
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium">
                  Title (Chinese) <span className="text-muted-foreground font-normal">optional</span>
                </label>
                <Input
                  placeholder="e.g. TOCFL準備"
                  value={form.title_zh}
